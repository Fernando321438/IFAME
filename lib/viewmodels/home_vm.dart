...
import 'package:Shoma/services/models/deezer_song_model.dart';
import 'package:Shoma/services/song_service.dart';
...
class HomeViewModel extends ChangeNotifier {
  ...
  Future<void> initAcr() async {
    try {
      acr
        ..init(
          host: 'identify-us-west-2.acrcloud.com', // https://www.acrcloud.com/
          accessKey: 'd697660b305e46249c6b56d559c01b70',
          accessSecret: '71qNX1bJZSFzkhgiLJdRvoxGwqQBLcrR7C9kjedV',
          setLog: true,
        )
