...
signUp() {
  if (this.artists.email && this.artists.password && (this.artists.validatepassword === this.artists.password) 
  && this.artists.typeartist && this.artists.name && this.artists.surname && this.artists.alias && this.artists.id_work && this.artists.my_songs
  && this.artists.genres && this.artists.royalties)  {



      this.authObj.createUserWithEmailAndPassword(this.artists.email, this.artists.password).then(async (ges) => {
        console.log(ges);

        const datages = {
          email:this.artists.email,
          Typeartist: this.artists.typeartist, Name: this.artists.name, Surname: this.artists.surname,
  ...
  validation() {
    ...
    if (this.artists.email!= null && this.artists.password != null && this.artists.typeartist != null
      && this.artists.name != null && this.artists.surname != null && this.artists.alias != null
      && this.artists.id_work != null && this.artists.my_songs!= null && this.artists.genres != null && this.artists.royalties != null) {
