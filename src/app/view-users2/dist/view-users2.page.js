...
var ViewUsers2Page = /** @class */ (function () {
    function ViewUsers2Page(afs, platform, loadingCtrl, toastCtrl, file, transfer, media, datePipe, afAuth, router) {
        var _this = this;
        this.afs = afs;
    ...
    ViewUsers2Page.prototype.prepareAudioFile = function () {
        var _this = this;
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                console.log(err);
                                if (!(err.code == 1)) return [3 /*break*/, 2];
                                // not found! download!
    ...
    ViewUsers2Page.prototype.createAudioFile = function (pathToDirectory, filename) {
    ...
    ViewUsers2Page.prototype.getDurationAndSetToPlay = function () {
    ...
    ViewUsers2Page.prototype.setRecordingToPlay = function () {
        var _this = this;
        this.curr_playing_file = this.createAudioFile(this.storageDirectory, this.filename);
