   ...
   playPrev(){
     ...
     if (index == 0) {
      var lastIndex = this.songs.length - 1;
       this.playSong(this.songs[lastIndex].Songname, this.songs[lastIndex].subTitle,this.songs[lastIndex].imgURL, this.songs[lastIndex].digitalaudio);
   
   }
   
   else {
     var prevIndex = index -1;
     this.playSong(this.songs[prevIndex].Songname, this.songs[prevIndex].subTitle,this.songs[prevIndex].imgURL, this.songs[prevIndex].digitalaudio);
