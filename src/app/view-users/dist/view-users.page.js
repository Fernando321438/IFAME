...
var ViewUsersPage = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        this.immagineLive();
                        _b = (_a = this.afStorage).ref;
                        _c = '/Live/';
                        return [4 /*yield*/, this.afAuth.currentUser];
                    case 1:
                        _b.apply(_a, [_c + (_h.sent()).uid + this.artistCurrent.recordname]).getDownloadURL().subscribe(function (usersnap) {
                            _this.user = __assign({ 'imgURL': usersnap.imgURL }, usersnap.payload.val());
                        ...
                        _e = (_d = this.afStorage).ref;
                        _f = '/Digital/';
                        return [4 /*yield*/, this.afAuth.currentUser];
                    case 2:
                        _e.apply(_d, [_f + (_h.sent()).uid + this.artistCurrent.songname]).getDownloadURL().subscribe(function (usersnap) {
                            _this.user = __assign({ 'imgURL': usersnap.imgURL }, usersnap.payload.val());
                            console.log(_this.user);
                        });
                        this.immagine.push({
    ...
    ViewUsersPage.prototype.initializeItems = function () {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.afs.collection('Live')
                            .valueChanges().pipe(operators_1.first()).toPromise()];
                    case 1:
                        records = _a.sent();
    ...
    ViewUsersPage.prototype.immagineLive = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.afAuth.currentUser];
                    case 1:
                        _b.apply(_a, [_c + (_d.sent()).uid + this.artistCurrent.recordname])
                            .getDownloadURL().subscribe(function (url) {
                            _this.artistCurrent.imgURL = url;
                            console.log(_this.artistCurrent.imgURL);
                        });
                        return [2 /*return*/];
                }
            });
    ...
    ViewUsersPage.prototype.immagineDigital = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.afAuth.currentUser];
                    case 1:
                        _b.apply(_a, [_c + (_d.sent()).uid + this.artistCurrent.songname])
                            .getDownloadURL().subscribe(function (url) {
                            _this.artistCurrent.imgURL = url;
                            console.log(_this.artistCurrent.imgURL);
                        });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this.records = this.records.filter(function (records) {
